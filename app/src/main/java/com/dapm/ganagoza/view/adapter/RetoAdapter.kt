...
class RetoAdapter(private val listaReto:MutableList<Reto>,private  val vistaModeloJuego: VistaModeloJuego):RecyclerView.Adapter<RetoViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RetoViewHolder {
        ...
        return RetoViewHolder(binding,vistaModeloJuego)
